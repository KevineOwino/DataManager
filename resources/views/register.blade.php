                    ...
                    <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                      <a class="w-auto pl-0" href="#">
                       {{-- <img src="images/logo.png" alt="Mono"> --}}
                        <span class="brand-name text-dark">Create Account</span>
                      </a>
                    </div>
                  </div>
                    ...
                    @include('status.status')
                      ...
                      <div class="row">
                        <div class="form-group col-md-12 mb-4">
                          <input type="text" name="name" class="form-control input-lg" id="name" aria-describedby="nameHelp" placeholder="Full Name" required>
                        </div>
                        <div class="form-group col-md-12 mb-4">
